    ...
    <style>
        ...
        * {
        ...
        tr:nth-child(even) td {
            background: rgba(107, 29, 58, 0.02);
        }
...
<body>
        ...
        <div class="slide" data-slide="3">
            ...
            <div class="grid-4" style="margin-bottom:15px;">
                ...
                <div class="card-box" style="border-right:4px solid var(--success);">
                    ...
                    <div style="font-size:0.8rem; color:var(--text-muted);">١٣.٨٨ من ١٥ | ١٠٠٪ توطين ونظام قيود</div>
                </div>
            </div>
            <div class="card-box" style="background:linear-gradient(135deg, #380B1B 0%, #6B1D3A 100%); color:#FFF; padding:18px 24px;">
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap;">
                    <div>
                        ...
                        <div style="font-size:2rem; font-weight:900;">٥٢.١٢٪ <small style="font-size:1rem; font-weight:400; opacity:0.9;">(أداء متقدم وتجاوز نصف المستهدفات المعتمدة)</small></div>
                    </div>
    ...
    <script>
        ...
        function showSlide(n) {
            ...
            counter.textContent = `شريحة ${currentSlide} من ${totalSlides}`;
            progress.style.width = `${(currentSlide / totalSlides) * 100}%`;
        }

        document.getElementById('btnPrev').addEventListener('click', () => showSlide(currentSlide - 1));
        document.getElementById('btnNext').addEventListener('click', () => showSlide(currentSlide + 1));
