        ...
        <div class="grid-3" style="margin-bottom:40px;">
            <div class="royal-card-v2">
                <div>
                    ...
                    <h3 style="color:var(--secondary); font-size:1.25rem;">خادم الحرمين الشريفين</h3>
                    <p style="font-size:0.95rem; opacity:0.8; margin-bottom:15px;">الملك سلمان بن عبدالعزيز آل سعود</p>
                </div>
