...
def create_presentation():
    ...
    p_sc.text = "نسبة الإنجاز الاستراتيجي الإجمالية الموزونة: ٣٢.٧٢٪  |  التقييم العام المعتمد: يحتاج إلى تحسين جذري وإعادة ضبط مسار"
    ...
    table_shape = s4.shapes.add_table(8, 6, PInches(0.8), PInches(1.5), PInches(11.733), PInches(5.4))
    ...
    matrix_data = [
        ...
        ("إيرادات الموازنة التشغيلية", "١,٥٢٧,٠٠٠ ر.س", "١,٥٢٧,٠٠٠ ر.س", "٥٨٢,١٦٧.٥٢ ر.س", "٣٨.١٢٪", "متأخر"),
        ("المساعدات العلاجية المباشرة", "١,٥٠٠,٠٠٠ ر.س", "٧٥٠,٠٠٠ ر.س", "٢٠٨,٦٠٥.٠٠ ر.س", "٢٧.٨١٪", "متأخر حرِج"),
        ...
        ("توطين الكادر وتطبيق قيود", "١٠٠٪", "١٠٠٪", "١٠٠٪ توطين + قيود", "١٠٠.٠٠٪", "مكتمل")
    ]
    ...
    t6_shape = s6.shapes.add_table(9, 5, PInches(0.8), PInches(1.5), PInches(11.733), PInches(5.4))
    t6 = t6_shape.table
