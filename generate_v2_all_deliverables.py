...
toc_data = [
    ...
    ["١٣", "ملحق الذمم والأصول الثابتة", "الملحق (٢): ذمم العضوية | الملحق (٣): الأصول الثابتة المشتراة", "ص ١٥"],
...
add_body_p("• صافي الأصول التراكمية: (٩٧٢,٧١٣ ريال) مقابل (٨٦٤,٠٥ ريال) في بداية الفترة.")
